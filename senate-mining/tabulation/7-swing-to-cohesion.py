...
fts = []
for i in xrange(3):
    fs.append(open('swing-%d.html'%i,'w'))
    fts.append(open('swing-%d.tex'%i,'w'))
...
ss += '</tr>'
ss += '<tr> <td>A</td> <td>B</td> <td>C</td> <td>D</td> <td>E</td> <td>OUT</td> <td>dif</td> <td>B*</td> <td>C*</td> <td>D*</td> </tr>'
...
for i in range(len(t)):
    ...
    ot = predictoutcome(ny,nn,nv,a,b)
    rate = ny
    mms = [[0,0,2,3,4],[0,1,0,3,4],[0,1,2,4,4]]
    oo = []
    rdif = []
    for mmi in range(3):
        mm = mms[mmi]
        ...
        for m2 in range(5):
            if m2==mm[m2]:
                ...
                cfactor = counts[m2][1]/counts[mm[m2]][1]
                ey +=  cfactor*counts[mm[m2]][0][0]
                en +=  cfactor*counts[mm[m2]][0][1]
                env += cfactor*counts[mm[m2]][0][2]
        #o2 = predictoutcome(round(ey),round(en),round(env),a,b)
...
print "bloc-majority swings w/r                       ",edif,"<br>"
print "bloc-majority swings w/out Tabling and Cloture ",dif,"<br>"
